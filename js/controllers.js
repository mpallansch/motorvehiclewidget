...
motorVehiclesControllers.controller('mainCtrl', ['$scope', '$http', '$window', function($scope, $http, $window) {
        ...
        $scope.strategies = ['Alcohol Interlocks', 'Red Light Camera', 'Speed Camera', 'Bicycle Helmet', 'Seat Belt Enforcement Campaign', 'Increased Seat Belt Fine', 'In Person Renewal', 'License Plate Impound', 'Limits on Diversion', 'Primary Enforcement Seat Belt Law', 'Saturation Patrols', 'Sobriety Checkpoints', 'Motorcycle Helmet', 'Vehicle Impoundment'];
        $scope.strategiesFull = {'Alcohol Interlocks': 'Alcohol Interlocks', 'Bicycle Helmet': 'Bicycle Helmet Laws for Children', 'Bicycle Helmets': 'Bicycle Helmet Laws for Children', 'In Person Renewal': 'In-Person License Renewal', 'In-Person License Renewal': 'In-Person License Renewal', 'Increased Seat Belt Fine': 'Increased Seat Belt Fines', 'Higher Seat Belt Fines': 'Increased Seat Belt Fines', 'License Plate Impound': 'License Plate Impoundment', 'License Plate Impoundment': 'License Plate Impoundment', 'Limits on Diversion': 'Limits on Diversion and Plea Agreements', 'Motorcycle Helmet': 'Universal Motorcycle Helmet Laws', 'Motorcycle Helmets': 'Universal Motorcycle Helmet Laws', 'Primary Enforcement Seat Belt Law': 'Primary Enforcement of Seat Belt Laws', 'Primary Enforcement of Seat Belt Laws': 'Primary Enforcement of Seat Belt Laws', 'Red Light Camera': 'Automated Red-Light Cameras', 'Red-Light Cameras': 'Automated Red-Light Cameras', 'Saturation Patrols': 'Saturation Patrols', 'Seat Belt Enforcement Campaign': 'High-Visibility Belt Law Enforcement', 'Sobriety Checkpoints': 'Sobriety Checkpoints', 'Speed Camera': 'Automated Speed Cameras', 'Speed Cameras': 'Automated Speed Cameras', 'Vehicle Impoundment': 'Vehicle Impoundment'};
